...
public class DiableAvionicsVirtuous_itanoCircus extends BaseHullMod {
    ...
    private final float FLUX_BONUS=10F;
    ...
    public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
        ...
        if (stats.getZeroFluxMinimumFluxLevel() != null)
            stats.getZeroFluxMinimumFluxLevel().modifyFlat(id,FLUX_BONUS);
    }
